...
function seatTone(status: SeatStatus, selected: boolean) {
  if (selected) return 'border-[#0EA5A4] bg-[#0EA5A4] text-white shadow-[0_10px_18px_rgba(14,165,164,0.24)]';
  if (status === 'available') return 'border-[#D9E8F7] bg-white text-[#334E71] hover:border-[#0EA5A4] hover:bg-[#F4FEFD]';
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-[26px] border border-[#DCEAF8] bg-[linear-gradient(180deg,#FCFEFF_0%,#F4FAFF_100%)] p-4 sm:p-5">
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-3">
          ...
          <LegendItem label="Seleccionada" className="border-[#0EA5A4] bg-[#0EA5A4]" />
