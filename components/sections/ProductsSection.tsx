...
export default function ProductsSection({
  ...
  const hasPackages = !loading && filteredItems.length > 0;
  if (!showSkeletons && !hasPackages) return null;

  return (
    <section id="excursiones" className="py-6 md:py-10 bg-transparent overflow-x-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <motion.div className="inline-block mb-3" variants={fadeInDownVariants}>
            <span className="badge-pluma pluma-underline block">{sectionBadge}</span>
          </motion.div>
          <motion.h2
