      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="rounded-3xl bg-white border border-gray-100 shadow-[0_14px_45px_rgba(0,0,0,0.06)] p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex items-start gap-3 flex-1">
            <div className="h-12 w-12 rounded-2xl bg-[#E8F6FF] text-[#2BB8BF] flex items-center justify-center shrink-0">
          ...
          <form onSubmit={submit} className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <input
              ...
              className="h-12 w-full sm:w-[320px] rounded-2xl border border-gray-200 bg-white px-4 text-sm outline-none focus:ring-2 focus:ring-[#2BB8BF]/20"
              disabled={loading}
            />
            <button
              type="submit"
              disabled={loading}
              className="h-12 rounded-2xl bg-[#2BB8BF] hover:bg-[#187AA6] text-white font-semibold text-sm px-6 transition-colors disabled:opacity-70"
            >
              Suscribirme
            </button>
          </form>
