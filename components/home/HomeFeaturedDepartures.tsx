...
export default function HomeFeaturedDepartures({ paquetes }: Props) {
  ...
  return (
    <section id="excursiones" className="bg-white py-10 md:py-14">
        ...
        <div className="relative">
          ...
          {showNext ? (
            <button
              type="button"
              onClick={handleNext}
              className="absolute right-0 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-[#E7EEF5] bg-white text-[#2BB8BF] shadow-[0_16px_36px_rgba(17,43,73,0.14)] transition hover:scale-[1.02] hover:shadow-[0_20px_42px_rgba(17,43,73,0.18)] md:inline-flex"
              aria-label="Ver más excursiones"
            >
