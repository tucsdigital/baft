    ...
    <div ref={containerRef} className="relative w-full">
      <div className="flex flex-col lg:flex-row items-stretch gap-2 rounded-[28px] bg-white/95 backdrop-blur-md shadow-[0_22px_60px_rgba(0,0,0,0.18)] border border-white/70 px-3 py-3 lg:py-2">
        ...
        <button
          ...
          className="w-full lg:w-[150px] h-12 lg:h-auto rounded-2xl lg:rounded-[22px] bg-[#2BB8BF] hover:bg-[#187AA6] text-white font-semibold text-sm transition-colors flex items-center justify-center"
        >
          Buscar
        </button>
      </div>
