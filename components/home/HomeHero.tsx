  ...
  return (
    <section className="relative isolate">
      <div className="relative min-h-[420px] pb-8 sm:min-h-[500px] sm:pb-10 md:min-h-[580px] md:pb-12 lg:min-h-[640px] lg:pb-14">
        ...
        <div className="relative z-10 container mx-auto flex min-h-[500px] items-end justify-center px-4 pb-4 pt-16 sm:min-h-[500px] sm:pb-5 sm:pt-20 md:min-h-[580px] md:px-6 md:pb-8 md:pt-24 lg:min-h-[640px] lg:px-8 lg:pb-10 lg:pt-28">
          <motion.div
