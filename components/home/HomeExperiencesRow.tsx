...
const items = [
  { title: "Salidas Grupales", subtitle: "Viajes acompañados", href: "/excursiones?tipo=grupal", icon: Users, color: "bg-[#E8F6FF] text-[#2BB8BF]" },
  { title: "Destinos Nacionales", subtitle: "Descubrí Argentina", href: "/excursiones?tipo=nacional", icon: Compass, color: "bg-[#E9FBF4] text-[#0B6E4F]" },
  { title: "Destinos Internacionales", subtitle: "Explorá el mundo", href: "/excursiones?tipo=internacional", icon: Globe, color: "bg-[#F0F2FF] text-[#4356D6]" },
  { title: "Escapadas", subtitle: "Ideas para desconectar", href: "/excursiones?tag=escapada", icon: Sparkles, color: "bg-[#FFF4E7] text-[#D97706]" },
  { title: "Eventos y Festivales", subtitle: "Viví experiencias únicas", href: "/excursiones?tag=evento", icon: PartyPopper, color: "bg-[#FFF0F6] text-[#DB2777]" },
] as const;
