        ...
        <div className="container mx-auto px-4">
          {paquetes.length > 0 ? (
            ...
            <div className="py-20 text-center">
              <h3 className="mb-4 text-base font-semibold md:text-lg lg:text-lg">No hay excursiones disponibles</h3>
              <p className="text-base text-gray-600 md:text-lg">
                Por el momento no hay excursiones en este destino. ¡Consultanos para armar tu viaje a medida!
              </p>
            </div>
          )}
        </div>
